...
{if isset($product->id) && !$product->is_virtual}
	...
	<div id="add_new_combination" style="display: none;">
		...
		<table>
			...
			<tr>
				<td style="width:150px;vertical-align:top;text-align:right;padding-right:10px;font-weight:bold;" class="col-left">
					{include file="controllers/products/multishop/checkbox.tpl" field="attribute_maximum_quantity" type="default"}
					<label>{l s='Maximum quantity:'}</label>
				</td>
				<td style="padding-bottom:5px;">
					<input size="3" maxlength="6" name="attribute_maximum_quantity" id="attribute_maximum_quantity" type="text" value="{$maximum_quantity}" />
					<p>{l s='The maximum quantity to buy this product (set to 1 to disable this feature)'}</p>
				</td>
			</tr>
			<tr>
				<td style="width:150px;vertical-align:top;text-align:right;padding-right:10px;font-weight:bold;" class="col-left">
