...
{if isset($product->id)}
	...
	<table cellpadding="5">
			...
			<tr>
				<td class="col-left"><label>{l s='Maximum quantity:'}</label></td>
				<td style="padding-bottom:5px;">
					<input size="3" maxlength="6" name="maximum_quantity" id="maximum_quantity" type="text" value="{$product->maximum_quantity|default:1}" />
					<p class="preference_description">{l s='The maximum quantity to buy this product (set to 1 to disable this feature)'}</p>
				</td>
			</tr>
			{/if}
		{if $ps_stock_management}
