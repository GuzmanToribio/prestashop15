...
function addCombination(idCombination, arrayOfIdAttributes, quantity, price, ecotax, id_image, reference, unit_price, minimal_quantity, maximum_quantity, available_date, combination_specific_price)
{
	...
	combination['maximum_quantity'] = maximum_quantity;
...
function findCombination(firstTime)
{
	...
	$('#maximum_quantity_wanted_p').fadeOut();
	...
	for (var combination = 0; combination < combinations.length; ++combination)
	{
		...
		if (combinationMatchForm)
		{
			...
			if (combinations[combination]['maximum_quantity'] > 1)
			{
				$('#maximum_quantity_label').html(combinations[combination]['maximum_quantity']);
				$('#maximum_quantity_wanted_p').fadeIn();
				$('#quantity_wanted').val(combinations[combination]['maximum_quantity']);
				$('#quantity_wanted').bind('keyup', function() {checkMaximumQuantity(combinations[combination]['maximum_quantity']);});
			}
...
function checkMaximumQuantity(maximum_quantity)
{
	if ($('#quantity_wanted').val() > maximum_quantity)
	{
		$('#quantity_wanted').css('border', '1px solid red');
		$('#maximum_quantity_wanted_p').css('color', 'red');
	}
	else
	{
		$('#quantity_wanted').css('border', '1px solid #BDC2C9');
		$('#maximum_quantity_wanted_p').css('color', '#374853');
	}
}
